 ...
 *  widgets into a GridBagLayout without resetting various values in a
 *  GridBagLayout instance.  All methods return the PackAs interface
 ...
 *
 *		new Packer(p)				// Create Layout and setLayout on container
 *		  .pack( l ).gridx(0) 			// Add to Container and layout
 *		  .add( t ).gridx(1).weightx(1).fillx();// Add to Container and layout
 *  </pre>
 *
...
public class Packer extends GridBagLayout implements PackAs {
	...
	/**
	 *  Add fill=HORIZONTAL to the constraints for the current
	 *  component if how == true 1 it if false.
	 */
	...
	/**
	 *  Add fill=VERTICAL to the constraints for the current
	 *  component.
	 */
	public PackAs filly()  {
		gc.fill = GridBagConstraints.VERTICAL;
	...
	/**
	 *  Add fill=BOTH to the constraints for the current
	 *  component if how == true 1 it if false.
	 */
